$_mod.def("/marko-path-router$0.5.0/src/components/router/component", function(require, exports, module, __filename, __dirname) { 'use strict'
const history = require('/marko-path-router$0.5.0/src/history/index-browser'/*'../../history'*/)
const nestedRoutePlaceholder = require('/marko-path-router$0.5.0/src/components/nested-route-placeholder/index.marko'/*'../nested-route-placeholder'*/)
