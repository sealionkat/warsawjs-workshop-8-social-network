$_mod.def("/marko-path-router$0.5.0/src/history/index-browser", function(require, exports, module, __filename, __dirname) { /**
 * Singleton History object
 */
const util = require('/util$0.10.3/util'/*'util'*/)
